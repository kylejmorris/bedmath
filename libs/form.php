...
class Form {
     ...
     */
    public function __construct($formArray = null, $db=null) {
        if($db==null) {
        ...
        $this->data = $formArray;
        $this->email = new Email($this->database); //Email object used to validation of email form data.
        $this->user = new User($this->database);
    }

    /**
     * Explicit method to add form data, since constructor will be deprecated. 
     * @param type $formData
     */
    public function addData($formData=null) {
        $this->data = $formData;
    }
