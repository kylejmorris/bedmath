...
class Questions extends Controller {
	...
	*/
	public function view($page, $topic, $bid) {
		...
		if(empty($topic) || $topic==0){$topic=null;} //Giving topic the optional value of 0 to represent 'all topics', since passing a null value through url is messy
		if(empty($bid) || $bid<10){$bid=10;} //Minimal bids to display are 10, since you can't bid less.
